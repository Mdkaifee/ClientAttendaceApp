                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (_) => ForgotPasswordScreen(
                                  organizationId:
                                      int.tryParse(orgController.text) ?? 0,
                                ),
                              ),
                            );
                          },
                      ...
                      child: ElevatedButton(
                        onPressed: vm.isLoading
                            ...
                            : () async {
                                ...
                                if (success &&
                                    vm.user != null &&
                                    vm.user!.accessToken.isNotEmpty) {
                                  ...
                                  Navigator.pushReplacement(
                                    ...
                                    MaterialPageRoute(
                                      builder: (_) => RegisterSelectScreen(
                                        ...
                                        tuitionCentreName:
                                            vm.user!.educationCentreName,
                                        organizationId: vm.user!.organizationId,
                                        tuitionCentreId:
                                            vm.user!.tuitionCentreId,
                                        educationCentreId:
                                            vm.user!.educationCentreId,
                                      ),
                                    ),
                                  );
                                }
